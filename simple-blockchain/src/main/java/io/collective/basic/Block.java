...
public class Block {
    ...
    private int nonce;
    private String hash, hashKey;

    public Block(String previousHash, long timestamp, int nonce) throws NoSuchAlgorithmException {
        this.previousHash = previousHash;
        this.timestamp = timestamp;
        this.nonce = nonce;
        this.hashKey = previousHash + String.valueOf(timestamp) + String.valueOf(nonce);
        this.hash = calculateHash(this.hashKey);
    }
    ...
    public String calculatedHash() throws NoSuchAlgorithmException {
        return calculateHash(this.hashKey);
    }
